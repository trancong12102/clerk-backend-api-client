...
if TYPE_CHECKING:
    from ..models.create_organization_invitation_body_private_metadata import (
        CreateOrganizationInvitationBodyPrivateMetadata,
    )
    from ..models.create_organization_invitation_body_public_metadata import (
...
class CreateOrganizationInvitationBody:
    ...
    Attributes:
        ...
        public_metadata (Union[Unset, CreateOrganizationInvitationBodyPublicMetadata]): Metadata saved on the
            organization invitation, read-only from the Frontend API and fully accessible (read/write) from the Backend API.
        private_metadata (Union[Unset, CreateOrganizationInvitationBodyPrivateMetadata]): Metadata saved on the
    ...
    inviter_user_id: str
    role: str
    public_metadata: Union[Unset, "CreateOrganizationInvitationBodyPublicMetadata"] = UNSET
    private_metadata: Union[Unset, "CreateOrganizationInvitationBodyPrivateMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        public_metadata: Union[Unset, CreateOrganizationInvitationBodyPublicMetadata]
        if isinstance(_public_metadata, Unset):
            public_metadata = UNSET
        else:
            public_metadata = CreateOrganizationInvitationBodyPublicMetadata.from_dict(_public_metadata)

        _private_metadata = d.pop("private_metadata", UNSET)
        private_metadata: Union[Unset, CreateOrganizationInvitationBodyPrivateMetadata]
        if isinstance(_private_metadata, Unset):
            private_metadata = UNSET
        else:
            private_metadata = CreateOrganizationInvitationBodyPrivateMetadata.from_dict(_private_metadata)
