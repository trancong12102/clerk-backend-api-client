...
class CreateUserBody:
    ...
    Attributes:
        ...
        delete_self_enabled (Union[None, Unset, bool]): If enabled, user can delete themselves via FAPI.
        create_organization_enabled (Union[None, Unset, bool]): If enabled, user can create organizations via FAPI.
