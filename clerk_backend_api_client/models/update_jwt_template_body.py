...
if TYPE_CHECKING:
    from ..models.update_jwt_template_body_claims import UpdateJWTTemplateBodyClaims


T = TypeVar("T", bound="UpdateJWTTemplateBody")


@_attrs_define
class UpdateJWTTemplateBody:
    """
    Attributes:
        name (Union[Unset, str]): JWT template name
        claims (Union[Unset, UpdateJWTTemplateBodyClaims]): JWT template claims in JSON format
    ...
    claims: Union[Unset, "UpdateJWTTemplateBodyClaims"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        claims: Union[Unset, UpdateJWTTemplateBodyClaims]
        if isinstance(_claims, Unset):
            claims = UNSET
        else:
            claims = UpdateJWTTemplateBodyClaims.from_dict(_claims)
        ...
        update_jwt_template_body.additional_properties = d
        return update_jwt_template_body
